...
def prepareSignalData(measurementPulseLength,excitationPulsesLength,excitationPulsesDelay,excitationPulsesPhase,freq,excitation_freq,awgRate,markerValueForExcitation=2,markerValueForMeasurement=1):
