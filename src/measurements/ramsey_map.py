...
def measure(alazar,
    ...
    durationExcitations = np.round(np.arange(durationExcitation_init, durationExcitation_final, durationExcitation_step,),roundDelayArray)
    ...
    ax = fig.gca()\n\
    plt.pcolor(durationExcitations*1e6,delays*1e6,20*np.log10(mag))\n\
    cbar = plt.colorbar()\n\
    cbar.ax.tick_params(labelsize=20)\n\
    cbar.ax.set_ylabel('S21',fontsize=20)\n\
    ax.tick_params(labelsize=20)\n\
    ax.set_ylabel('Delay between pulses (us)',fontsize=20)\n\
    ax.set_xlabel('Pi over 2 pulse Length (µs)',fontsize=20)\n\
    ...
    try:
        ...
        for idx_piover2_pulse_length, durationExcitation in enumerate(durationExcitations):
            ...
            for idx, delayBetweenPulses in enumerate(delays):
                ...
                Is[idx_piover2_pulse_length,idx] = I
                Qs[idx_piover2_pulse_length,idx] = Q 
                ...
                plt.pause(0.05)
                plt.pcolor(durationExcitations*1e9,delays*1e6,mags.T)
